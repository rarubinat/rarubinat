...
| Moodboard | Angular + AOS + TailwindCSS + NodeJS backend + Supabase + Render  | A stylish frontend moodboard app built with Angular, AOS animations, and Tailwind CSS, with NodeJs backend to gestion the project on Render and Supabase BBDD | [Live](https://rarubinat.github.io/moodboard-app/) |
